        ...
        <div class="stars" >
            <?php
                ...
                echo '<form method="POST" action="./comment.php?id=' . $id .'">';
                    ...
                    echo    '<input class="star star-5" id="star-5" type="radio" value="5" name="ReviewPoint"/>';
                    echo    '<label class="star star-5" for="star-5"></label>';
                    echo    '<input class="star star-4" id="star-4" type="radio" value="4" name="ReviewPoint"/>';
                    echo    '<label class="star star-4" for="star-4"></label>';
                    echo    '<input class="star star-3" id="star-3" type="radio" value="3" name="ReviewPoint"/>';
                    echo    '<label class="star star-3" for="star-3"></label>';
                    echo    '<input class="star star-2" id="star-2" type="radio" value="2" name="ReviewPoint"/>';
                    echo    '<label class="star star-2" for="star-2"></label>';
                    echo    '<input class="star star-1" id="star-1" type="radio" value="1" name="ReviewPoint"/>';
